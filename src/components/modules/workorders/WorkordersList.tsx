...
export function WorkordersList() {
  ...
  return (
    <div className="space-y-6">
      {/* Header & Page Title */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs min-w-0 w-full max-w-full">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
          {/* View Mode Switcher */}
          <div className="flex items-center overflow-x-auto bg-stone-100 p-1 rounded-xl border border-slate-200 w-full sm:w-auto">
            <button
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs rounded-xl shadow-xs transition-all w-full sm:w-auto shrink-0"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 min-w-0 w-full max-w-full">
      ...
      {viewMode === 'calendar' ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-xs min-w-0 w-full max-w-full">
            ...
            {workOrders.map((wo) => {
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <span className="font-mono text-[11px] font-bold text-amber-800 bg-amber-50 px-2 py-0.5 rounded border border-amber-500/20">
                    ...
                    <div className="flex flex-col items-end gap-1 shrink-0">
                      ...
                      {isOverdue && (
                        <span className="text-[9px] font-bold text-red-700 bg-red-50 border border-red-200 px-1.5 py-0.5 rounded-xs flex items-center gap-0.5">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-slate-600 bg-stone-50 p-2.5 rounded-xl border border-slate-100">
                    <div>
                  ...
                  <div className="flex items-center justify-between pt-1 text-xs">
                    <span className="text-[11px] text-slate-400 capitalize">{wo.work_type.replace('_', ' ')}</span>
                    <span className="text-amber-600 font-bold inline-flex items-center gap-0.5">
                      Open Work Order <ChevronRight className="h-3.5 w-3.5" />
                    </span>
                  </div>
                </div>
              );

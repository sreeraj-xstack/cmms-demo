...
import { Sparkles, Search, CheckCircle2, BookOpen, Wrench, Tag, Cpu, Check } from 'lucide-react';
...
export function AISearchAssistantModal({
  ...
  return (
    <Drawer
      isOpen={isOpen}
      onClose={onClose}
      title="CMMS Industrial AI Matcher"
      subtitle="Domain-aware NLP engine matching fault codes, sub-assemblies & OEM manuals"
      badge={<Sparkles className="h-5 w-5 text-amber-500 animate-pulse" />}
      maxWidth="xl"
    >

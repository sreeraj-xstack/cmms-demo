...
import { Plus, Trash2, CheckSquare, Clock, ShieldAlert, Sparkles } from 'lucide-react';
...
export function CreateProcedureModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Create Work Procedure / SOP"
      subtitle="Define step-by-step checklists & mandatory verification rules"
              ...
              <div key={idx} className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-3 relative">
                ...
                <div className="flex items-center gap-6 pt-1">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-xs font-semibold text-slate-700">Mandatory Step</span>
                  </label>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="rounded-xs text-amber-600 focus:ring-amber-500"
                    />
                    <span className="text-xs font-semibold text-slate-700">Requires Photo Proof</span>
                  </label>
                </div>
              </div>
            ))}
